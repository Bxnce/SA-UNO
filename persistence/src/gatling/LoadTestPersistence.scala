...
class LoadTestPersistence extends Simulation {
  ...
  setUp(
    dbLoadScenario.inject(rampUsers(10000).during(10.seconds)),
    dbSaveScenario.inject(rampUsers(10000).during(10.seconds))
